...
const TiposIncidentesPage: NextPage = () => {
  ...
  const getRowId = (row: TipoIncidenteType) => row._id

  return (
    <>
      <Head>
        <title>Tabla de Tipos Incidentes</title>
...
export default TiposIncidentesPage
